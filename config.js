...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "SHABAN-MD~WV9kQRJT#jmkboPgrfFtsPHZdIUHnyVqvmRlouhCTw1NsHk-AGmc",
// add your Session Id
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ BY WILSON S*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/tasodv.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> Zinda Hun Yar *WE THE BEST *⚡",
// add alive msg here 
